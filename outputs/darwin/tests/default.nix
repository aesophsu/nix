...
in
{
  ...
  "darwin-stella-home-manager-option" =
    present && lib.hasAttrByPath [ "home-manager" "users" ] cfg.options;
  ...
  "darwin-stella-fonts-option" =
    present && lib.hasAttrByPath [ "modules" "desktop" "fonts" "enable" ] cfg.options;
